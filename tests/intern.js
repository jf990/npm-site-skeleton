...
//
// Run in the browser:  http://local.arcgis.com:3333/node_modules/intern/client.html?config=tests/intern
define({
	...
	loaderOptions: {
		...
		packages: [ { name: 'public/app', location: '.' } ]
	},

	// Non-functional test suite(s) to run in each browser
	suites: [ 'tests/unit/common-test' ],

	// Functional test suite(s) to execute against each browser once non-functional tests are completed
	functionalSuites: [ 'tests/functional/index-test' ],
